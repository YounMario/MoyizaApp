...
public class BasicNetwork implements Network {
    ...
    private ExecutorDelivery dilivery;
    ...
    public BasicNetwork(HttpStack httpStack, ByteArrayPool pool) {
        ...
        mPool = pool;
        dilivery = new ExecutorDelivery(new Handler(Looper.getMainLooper()));
    }
     ...
     */
    private byte[] entityToBytes(HttpEntity entity, final Request<?> request) throws IOException, ServerError {
        ...
        try {
            ...
            ProcessInputStream pIn = new ProcessInputStream(in, total, new ProcessInputStream.onReadListener() {
                @Override
                public void onRead(long current, long total) {
                    dilivery.onGeting(request, current, total);
                }
            });
