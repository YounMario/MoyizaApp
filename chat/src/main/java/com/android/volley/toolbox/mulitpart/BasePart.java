...
import com.android.volley.toolbox.util.ByteArrayBuffer;
import com.android.volley.toolbox.util.EncodingUtils;
...
/* package */ abstract class BasePart implements Part {
    ...
    protected static final byte[] CRLF = EncodingUtils.getAsciiBytes("\r\n");
