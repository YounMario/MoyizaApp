...
public class DimenUtils {
    ...
    public static final DisplayMetrics mMetrics = App.getIns().getResources()
            .getDisplayMetrics();
    ...
    public static int getStatusBarHeight2() {
        ...
        try {
            ...
            sStatusBarHeight = App.getIns().getResources()
    ...
    public static void showAll() {
        ...
        Toast.makeText(App.getIns(), text, Toast.LENGTH_LONG).show();
    }
