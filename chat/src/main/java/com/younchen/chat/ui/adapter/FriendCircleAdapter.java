...
import com.younchen.chat.ui.CommentsDetailActivity;
...
import com.younchen.chat.ui.controller.PariseAndCommentsController;
...
public class FriendCircleAdapter extends MulitTypeAdapter<FriendArticle> {
    ...
    public void covert(ViewHolder holder, int type, FriendArticle item) {
        ...
        new PariseAndCommentsController(itemView, new PariseAndCommentsController.ClickListener() {
            @Override
