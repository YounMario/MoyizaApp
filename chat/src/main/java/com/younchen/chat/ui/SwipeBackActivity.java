...
import com.younchen.chat.ui.components.layout.SwipeBackLayout;
...
public abstract class SwipeBackActivity extends BaseActivity implements SwipeBackLayout.SwipeBackListener {
    ...
    private View getContainer() {
        ...
        ivShadow.setBackgroundColor(getResources().getColor(R.color.abc_background_cache_hint_selector_material_dark));
